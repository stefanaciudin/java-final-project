    ...
    <div className="flex-col items-center justify-center min-h-screen bg-[#1e1e2e]">
      ...
      <div className="flex justify-center mb-8">
        <button
          ...
          className={`mt-2 ml-4 mr-4 text-sm text-[#cdd6f4] py-1 px-3 rounded-lg ${
      ...
      <div className="flex flex-col items-center">
        <p className="text-lg font-semibold mb-4 text-[#cdd6f4]">Your top genres based on listening history:</p>
